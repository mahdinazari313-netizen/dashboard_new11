...
/**
 * هر ردیف = یک Scenario Board مستقل (بخش ۲۰ سند)، همیشه قابل‌مشاهده حتی
 * بدون Trigger فعال. داخل هر کارت، خلاصه تنظیمات + لیست Triggerهای فعلاً فعال
 * (هرکدام با دکمه Silent مخصوص خودشان - بخش ۱۴ سند) نمایش داده می‌شود.
 */
