...
/**
 * فاصلهٔ زمانی موثر بین دو timestamp را با کسر کامل/جزئی شنبه و یکشنبه
 * بر اساس Time Zone فعلی دستگاه محاسبه می‌کند.
 *
 * این Utility فقط برای Dual in One Timeframe است و در محاسبات معمول
 * اعتبار سیگنال، Repeat Interval یا Display Duration استفاده نمی‌شود.
 */
